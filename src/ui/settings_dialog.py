...
class SettingsDialog(QDialog):
    ...
    def _detection_section(self) -> QWidget:
        ...
        self._combo_previous_action_source = QComboBox()
        self._combo_previous_action_source.addItem("Send attempt", "send_attempt")
        self._combo_previous_action_source.addItem("Tracker confirmed", "tracker_confirmed")
        self._combo_previous_action_source.addItem("Tracker + fallback", "tracker_with_fallback")
        fl.addRow(_row_label("Prev action:"), self._combo_previous_action_source)
        tracker_row = QHBoxLayout()
        self._check_action_history_enabled = QCheckBox("Tracker ROI")
        self._spin_action_history_left = QSpinBox()
        self._spin_action_history_left.setRange(-4000, 4000)
        self._spin_action_history_left.setPrefix("L ")
        self._spin_action_history_left.setMaximumWidth(74)
        self._spin_action_history_top = QSpinBox()
        self._spin_action_history_top.setRange(-4000, 4000)
        self._spin_action_history_top.setPrefix("T ")
        self._spin_action_history_top.setMaximumWidth(74)
        self._spin_action_history_width = QSpinBox()
        self._spin_action_history_width.setRange(0, 3000)
        self._spin_action_history_width.setPrefix("W ")
        self._spin_action_history_width.setMaximumWidth(74)
        self._spin_action_history_height = QSpinBox()
        self._spin_action_history_height.setRange(0, 500)
        self._spin_action_history_height.setPrefix("H ")
        self._spin_action_history_height.setMaximumWidth(74)
        self._spin_action_history_spawn_width = QSpinBox()
        self._spin_action_history_spawn_width.setRange(4, 400)
        self._spin_action_history_spawn_width.setPrefix("S ")
        self._spin_action_history_spawn_width.setMaximumWidth(74)
        tracker_row.addWidget(self._check_action_history_enabled)
        tracker_row.addWidget(self._spin_action_history_left)
        tracker_row.addWidget(self._spin_action_history_top)
        tracker_row.addWidget(self._spin_action_history_width)
        tracker_row.addWidget(self._spin_action_history_height)
        tracker_row.addWidget(self._spin_action_history_spawn_width)
        tracker_row.addStretch()
        fl.addRow(_row_label("Tracker:"), tracker_row)
        tracker_timing_row = QHBoxLayout()
        self._spin_action_history_confirm_frames = QSpinBox()
        self._spin_action_history_confirm_frames.setRange(1, 10)
        self._spin_action_history_confirm_frames.setPrefix("N ")
        self._spin_action_history_confirm_frames.setMaximumWidth(62)
        self._spin_action_history_cast_frames = QSpinBox()
        self._spin_action_history_cast_frames.setRange(1, 20)
        self._spin_action_history_cast_frames.setPrefix("Cast ")
        self._spin_action_history_cast_frames.setMaximumWidth(82)
        self._spin_action_history_timeout_ms = QSpinBox()
        self._spin_action_history_timeout_ms.setRange(100, 10000)
        self._spin_action_history_timeout_ms.setSuffix(" ms")
        self._spin_action_history_timeout_ms.setMaximumWidth(86)
        self._spin_action_history_motion_gate = QSpinBox()
        self._spin_action_history_motion_gate.setRange(0, 80)
        self._spin_action_history_motion_gate.setPrefix("M ")
        self._spin_action_history_motion_gate.setSpecialValueText("off")
        self._spin_action_history_motion_gate.setMaximumWidth(74)
        self._check_action_history_cancel_x = QCheckBox("Cancel X")
        self._spin_action_history_cancel_x_threshold = QSpinBox()
        self._spin_action_history_cancel_x_threshold.setRange(1, 100)
        self._spin_action_history_cancel_x_threshold.setPrefix("X ")
        self._spin_action_history_cancel_x_threshold.setSuffix("%")
        self._spin_action_history_cancel_x_threshold.setMaximumWidth(82)
        tracker_timing_row.addWidget(self._spin_action_history_confirm_frames)
        tracker_timing_row.addWidget(self._spin_action_history_cast_frames)
        tracker_timing_row.addWidget(self._spin_action_history_timeout_ms)
        tracker_timing_row.addWidget(self._spin_action_history_motion_gate)
        tracker_timing_row.addWidget(self._check_action_history_cancel_x)
        tracker_timing_row.addWidget(self._spin_action_history_cancel_x_threshold)
        tracker_timing_row.addStretch()
        fl.addRow(_row_label("Tracker tune:"), tracker_timing_row)
    ...
    def _connect_signals(self) -> None:
        ...
        self._combo_previous_action_source.currentIndexChanged.connect(self._on_detection_changed)
        self._check_action_history_enabled.toggled.connect(self._on_detection_changed)
        self._spin_action_history_left.valueChanged.connect(self._on_detection_changed)
        self._spin_action_history_top.valueChanged.connect(self._on_detection_changed)
        self._spin_action_history_width.valueChanged.connect(self._on_detection_changed)
        self._spin_action_history_height.valueChanged.connect(self._on_detection_changed)
        self._spin_action_history_spawn_width.valueChanged.connect(self._on_detection_changed)
        self._spin_action_history_confirm_frames.valueChanged.connect(self._on_detection_changed)
        self._spin_action_history_cast_frames.valueChanged.connect(self._on_detection_changed)
        self._spin_action_history_timeout_ms.valueChanged.connect(self._on_detection_changed)
        self._spin_action_history_motion_gate.valueChanged.connect(self._on_detection_changed)
        self._check_action_history_cancel_x.toggled.connect(self._on_detection_changed)
        self._spin_action_history_cancel_x_threshold.valueChanged.connect(self._on_detection_changed)
    ...
    def sync_from_config(self) -> None:
        ...
        self._combo_previous_action_source.blockSignals(True)
        self._check_action_history_enabled.blockSignals(True)
        self._spin_action_history_left.blockSignals(True)
        self._spin_action_history_top.blockSignals(True)
        self._spin_action_history_width.blockSignals(True)
        self._spin_action_history_height.blockSignals(True)
        self._spin_action_history_spawn_width.blockSignals(True)
        self._spin_action_history_confirm_frames.blockSignals(True)
        self._spin_action_history_cast_frames.blockSignals(True)
        self._spin_action_history_timeout_ms.blockSignals(True)
        self._spin_action_history_motion_gate.blockSignals(True)
        self._check_action_history_cancel_x.blockSignals(True)
        self._spin_action_history_cancel_x_threshold.blockSignals(True)
        ...
        idx = self._combo_previous_action_source.findData(prev_source)
        self._combo_previous_action_source.setCurrentIndex(idx if idx >= 0 else 0)
        tracker = dict(getattr(self._config, "action_history_tracker", {}) or {})
        self._check_action_history_enabled.setChecked(bool(tracker.get("enabled", False)))
        self._spin_action_history_left.setValue(int(tracker.get("left", 0)))
        self._spin_action_history_top.setValue(int(tracker.get("top", 0)))
        self._spin_action_history_width.setValue(int(tracker.get("width", 0)))
        self._spin_action_history_height.setValue(int(tracker.get("height", 0)))
        self._spin_action_history_spawn_width.setValue(int(tracker.get("spawn_width", 36) or 36))
        self._spin_action_history_confirm_frames.setValue(int(tracker.get("confirm_frames", 2) or 2))
        self._spin_action_history_cast_frames.setValue(
            int(tracker.get("stationary_frames_for_cast", 3) or 3)
        )
        self._spin_action_history_timeout_ms.setValue(
            int(tracker.get("pending_timeout_ms", 2500) or 2500)
        )
        self._spin_action_history_motion_gate.setValue(
            int(round(float(tracker.get("motion_gate_threshold", 12.0) or 12.0)))
        )
        self._check_action_history_cancel_x.setChecked(bool(tracker.get("cancel_x_enabled", True)))
        self._spin_action_history_cancel_x_threshold.setValue(
            int(round(float(tracker.get("cancel_x_threshold", 0.10) or 0.10) * 100))
        )
        ...
        self._combo_previous_action_source.blockSignals(False)
        self._check_action_history_enabled.blockSignals(False)
        self._spin_action_history_left.blockSignals(False)
        self._spin_action_history_top.blockSignals(False)
        self._spin_action_history_width.blockSignals(False)
        self._spin_action_history_height.blockSignals(False)
        self._spin_action_history_spawn_width.blockSignals(False)
        self._spin_action_history_confirm_frames.blockSignals(False)
        self._spin_action_history_cast_frames.blockSignals(False)
        self._spin_action_history_timeout_ms.blockSignals(False)
        self._spin_action_history_motion_gate.blockSignals(False)
        self._check_action_history_cancel_x.blockSignals(False)
        self._spin_action_history_cancel_x_threshold.blockSignals(False)
    ...
    def _on_detection_changed(self) -> None:
        ...
        self._config.previous_action_source = str(
            self._combo_previous_action_source.currentData() or "send_attempt"
        ).strip().lower() or "send_attempt"
        self._config.action_history_tracker = {
            "enabled": self._check_action_history_enabled.isChecked(),
            "left": self._spin_action_history_left.value(),
            "top": self._spin_action_history_top.value(),
            "width": self._spin_action_history_width.value(),
            "height": self._spin_action_history_height.value(),
            "spawn_width": self._spin_action_history_spawn_width.value(),
            "confirm_frames": self._spin_action_history_confirm_frames.value(),
            "stationary_frames_for_cast": self._spin_action_history_cast_frames.value(),
            "pending_timeout_ms": self._spin_action_history_timeout_ms.value(),
            "motion_gate_threshold": float(self._spin_action_history_motion_gate.value()),
            "cancel_x_enabled": self._check_action_history_cancel_x.isChecked(),
            "cancel_x_threshold": self._spin_action_history_cancel_x_threshold.value() / 100.0,
        }
